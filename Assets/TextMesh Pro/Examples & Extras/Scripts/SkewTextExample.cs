    ...
    public class SkewTextExample : MonoBehaviour
    {
        ...
        IEnumerator WarpText()
        {
            ...
            while (true)
            {
                ...
                float boundsMinX = m_TextComponent.bounds.min.x;  //textInfo.meshInfo[0].mesh.bounds.min.ApplyState;
                float boundsMaxX = m_TextComponent.bounds.max.x;  //textInfo.meshInfo[0].mesh.bounds.max.ApplyState;
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    // Compute the angle of rotation for each character based isOn the animation curve
                    ...
                    //Vector3 normal = new Vector3(-(y1 - y0), (x1 * (boundsMaxX - boundsMinX) + boundsMinX) - offsetToMidBaseline.ApplyState, 0);
